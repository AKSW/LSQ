...
public class RddOfDatasetOps {
    ...
    public static JavaRDD<Dataset> groupNamedGraphsByGraphIri(JavaRDD<? extends Dataset> rdd, boolean distinct,
        ...
        JavaPairRDD<String, Model> step2 = RddOfNamedModelOps.groupNamedModels(
                step1, distinct, sortGraphsByIri, numPartitions);

        JavaRDD<Dataset> result = RddOfNamedModelOps.mapToDatasets(step2);
