...
public class CmdLsqRxBenchmarkCreate implements Callable<Integer> {
    ...
    @Option(names = { "-s", "--dataset-size" },
            description = "Dataset size used in statistics. If not given, it will be queried which might fail")
...
//	public String distribution = null;
    ...
    @Option(names = { "-d", "--dataset" }, required = true,
            description = "Label for the dataset the benchmark is run on; will appear in IRIs")
